<?= $this->extend('layouts/templates_guest'); ?>
                ...
                <nav class="classy-navbar justify-content-between" id="palatinNav">
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            ...
                            <!-- Button -->
                            <div class="menu-btn">
                                <a href=<?= ($user==null)? url_to("login"):base_url()?> class="btn palatin-btn">Make
                                    a Reservation</a>
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-9">
                        ...
                        <div class="hero-slides-content" data-animation="fadeInUp" data-delay="100ms">
                            ...
                            <a href="#" class="btn palatin-btn mt-50" data-animation="fadeInUp" data-delay="900ms">Read
                                More</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-rooms-area wow fadeInUp" data-wow-delay="100ms">
                    ...
                    <!-- Price -->
                    <p class="price-from">From <?= $tipe['harga']?>/night</p>
                    <!-- Rooms Text -->
